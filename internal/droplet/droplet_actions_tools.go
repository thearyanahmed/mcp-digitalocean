	...
	tools := []server.ServerTool{
		{
			...
			Tool: mcp.NewTool("digitalocean-reboot-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-reset-droplet-password",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-rebuild-droplet-by-slug",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-power-cycle-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-power-on-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-power-off-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-shutdown-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-enable-backups-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-disable-backups-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-snapshot-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-enable-ipv6-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-enable-private-net-droplets-tag",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-power-cycle-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-power-on-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-power-off-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-shutdown-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-restore-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-resize-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-rebuild-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-rename-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-change-kernel-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-enable-ipv6-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-enable-backups-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-disable-backups-droplet",
		...
		},
		{
			...
			Tool: mcp.NewTool("digitalocean-snapshot-droplet",
